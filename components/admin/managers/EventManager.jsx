            ...
            <Card className="border-none shadow-2xl bg-white rounded-[2.5rem] overflow-hidden">
                <CardHeader className="p-8 md:p-12 border-b border-gray-50 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 bg-gray-50/30">
                    <div className="space-y-1">
                        ...
                        <CardTitle className="text-3xl font-serif font-bold text-gray-900">Listado de Eventos</CardTitle>
                    </div>
                    <Button
                        variant="green"
                ...
                <CardContent className="p-0">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-32 space-y-4">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-300">Cargando Agenda</p>
                        </div>
                    ) : events.length === 0 ? (
                        <div className="py-32 text-center space-y-4">
                            ...
                            <p className="text-gray-400 font-light italic">No hay eventos agendados todavía.</p>
                        </div>
                    ) : (
                        <div id='event-table'>
                            {/* Desktop screens */}
                    ...
                    <div className="bg-black p-8 md:p-12">
                        <DialogHeader className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[var(--puembo-green)]">Editor de Eventos</span>
                            </div>
