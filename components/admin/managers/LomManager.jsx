...
export default function LomManager() {
  ...
  return (
    <div className="space-y-16">
      ...
      <Card
        id="editorial-form"
        className="border-none shadow-2xl bg-white rounded-[2.5rem] overflow-hidden"
      >
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center gap-3 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0 scrollbar-hide">
              <div className="flex items-center bg-gray-50 p-1.5 rounded-full border border-gray-100">
                ...
                <Button
                  variant={
                    sortConfig.key === "publication_date" ? "green" : "ghost"
                  }
            ...
            {selectedIds.length > 0 && (
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    className="bg-red-500 hover:bg-red-600 text-white rounded-full font-bold text-[10px] uppercase tracking-widest px-10 h-12 gap-3 shadow-xl transition-all"
            ...
            <div className="py-32 text-center space-y-4">
              ...
              <p className="text-gray-400 font-light italic text-lg font-serif px-8">
                {searchTerm
                  ...
                  : "No hay devocionales publicados todavía."}
              </p>
            </div>
          ) : (
            <div id="lom-table">
