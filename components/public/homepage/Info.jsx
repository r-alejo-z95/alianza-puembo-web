          ...
          <div className="w-full md:w-1/2 space-y-10">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-gray-900 leading-tight">
                ...
                <span className="text-[var(--puembo-green)] italic">convicciones firmes</span>
              </h2>
              
              <p className={cn(secondaryTextSizes, "text-gray-600 leading-relaxed max-w-xl")}>
                Compartimos nuestra fe con amor y queremos que formes parte de nuestra casa. 
                En Alianza Puembo, creemos en el poder de la comunidad y el crecimiento espiritual conjunto.
              </p>
            </motion.div>
            ...
            >
              <Link href="/noticias" className="group">
                <div className="p-6 bg-gray-50 rounded-3xl border border-transparent hover:border-[var(--puembo-green)]/30 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2 text-lg">Noticias</h3>
                  <p className="text-sm text-gray-500 mb-4">Mantente al tanto de lo que sucede en nuestra comunidad.</p>
              ...
              <Link href="/eventos/proximos-eventos" className="group">
                <div className="p-6 bg-gray-50 rounded-3xl border border-transparent hover:border-[var(--puembo-green)]/30 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2 text-lg">Eventos</h3>
                  <p className="text-sm text-gray-500 mb-4">Descubre nuestras próximas actividades y reuniones.</p>
                  <div className="flex items-center text-xs font-bold text-[var(--puembo-green)] uppercase tracking-wider group-hover:gap-2 transition-all">
