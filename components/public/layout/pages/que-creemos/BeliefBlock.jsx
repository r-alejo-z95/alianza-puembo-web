...
export function BeliefBlock({ belief, index }) {
  ...
  return (
    <div className={cn(sectionPy, "relative group")}>
      <div
        className={cn(
      ...
      >
        ...
        <div
          className={cn(
            "lg:col-span-7 relative aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl transition-all duration-700 group-hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)]",
        ...
        >
          ...
          {/* Subtle Accent Line */}
          <div className={cn(
            "absolute bottom-8 w-24 h-1 bg-[var(--puembo-green)] rounded-full",
        ...
        {/* Content Side */}
        <div className={cn(
          "lg:col-span-5 flex flex-col justify-center space-y-8",
          ...
          <div className={cn(
            ...
            {symbol && (
              <div className={cn(
                "relative size-16 md:size-20 transition-all duration-700 group-hover:scale-110",
            ...
            <div className="space-y-2">
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[var(--puembo-green)] opacity-70 block">
                Fundamento {index + 1}
              </span>
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-gray-900 leading-tight">
                {name}
              </h3>
            </div>
          </div>
          ...
          <div className={cn(
            "relative p-8 md:p-10 bg-white rounded-[2rem] border border-gray-100 shadow-[0_15px_40px_-12px_rgba(0,0,0,0.05)] transition-all duration-500 hover:border-[var(--puembo-green)]/20",
            ...
            <div className="space-y-4">
              ...
              <cite className={cn(
                "block text-xs md:text-sm not-italic font-black uppercase tracking-widest text-[var(--puembo-green)] opacity-80",
