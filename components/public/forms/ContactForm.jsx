    ...
    <div className="w-full max-w-2xl mx-auto py-2">
      {state.success ? (
        <motion.div 
          ...
          className="text-center bg-green-50 text-[var(--puembo-green)] p-5 md:p-6 rounded-2xl border border-green-100 space-y-2"
        >
          <p className="text-lg font-bold">¡Mensaje enviado!</p>
          <p className="text-sm opacity-80">{state.message}</p>
        </motion.div>
      ) : (
        <form action={formAction} className="space-y-4 md:space-y-6 px-2 md:px-0">
          <input type="hidden" name="turnstile_token" value={captchaToken || ''} />
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="name" className="text-[10px] md:text-sm font-bold text-gray-700 uppercase tracking-widest ml-1">Nombre</Label>
              <Input 
                id="name" 
                name="name" 
                placeholder="Tu nombre completo" 
                className="h-11 rounded-lg bg-gray-50/30 border-gray-200 focus:bg-white transition-all text-base"
              />
              {state.errors?.name && (
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-[10px] md:text-sm font-bold text-gray-700 uppercase tracking-widest ml-1">Correo Electrónico</Label>
              <Input 
                id="email" 
                name="email" 
                type="email" 
          ...
          <div className="space-y-1.5">
            <Label htmlFor="phone" className="text-[10px] md:text-sm font-bold text-gray-700 uppercase tracking-widest ml-1">Teléfono (Opcional)</Label>
            <Input 
              id="phone" 
              name="phone" 
              type="tel" 
          ...
          <div className="space-y-1.5">
            <Label htmlFor="message" className="text-[10px] md:text-sm font-bold text-gray-700 uppercase tracking-widest ml-1">Mensaje</Label>
            <Textarea 
              id="message" 
              name="message" 
              placeholder="¿Cómo podemos ayudarte?" 
              className="min-h-[120px] rounded-lg bg-gray-50/30 border-gray-200 focus:bg-white transition-all resize-none p-3 text-base"
            />
