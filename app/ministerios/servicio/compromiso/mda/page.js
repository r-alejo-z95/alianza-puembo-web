...
export const metadata = {
  ...
  alternates: {
    canonical: "/ministerios/servicio/compromiso/mda",
  },
};
...
export default function MDA() {
  const introSectionData = {
    ...
    imageUrl: "/ministerios/servicio/compromiso/mda/MDA.jpg",
