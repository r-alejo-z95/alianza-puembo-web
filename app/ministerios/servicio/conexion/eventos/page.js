...
export const metadata = {
  ...
  alternates: {
    canonical: "/ministerios/servicio/conexion/eventos",
  },
};
...
export default function Eventos() {
  const introSectionData = {
    ...
    imageUrl: "/ministerios/servicio/conexion/eventos/Eventos.jpg",
  ...
  const eventsList = {
    ...
    items: [
      ...
      {
        type: "link",
        href: "/ministerios/servicio/conexion/eventos/eje",
  ...
  return (
    ...
    >
      <MinistryContentSection {...eventsList} />
    </PublicPageLayout>
  );
}
