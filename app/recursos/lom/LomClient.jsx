...
export function LomClient({ initialPosts = [], initialPassages = [] }) {
  ...
  return (
    <div className={cn(contentSection, "bg-gray-50/50 pt-12 pb-24 space-y-16")}>
      <section className="max-w-7xl mx-auto w-full">
        ...
        <motion.div
          {...fadeIn}
          className="bg-white p-6 rounded-3xl shadow-lg border border-gray-100 mb-12 flex flex-col md:flex-row gap-4 items-center"
        >
          <div className="relative w-full md:grow">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
            <Input
              placeholder="Buscar devocional por título..."
              className="pl-12 h-12 rounded-2xl bg-gray-50/50 border-gray-100 focus:bg-white transition-all"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3 space-y-10">
            {currentPosts.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-gray-200 text-gray-400">
                No se encontraron devocionales que coincidan con tu búsqueda.
              </div>
            ) : (
          ...
          <aside className="space-y-8">
            ...
            >
              ...
              <FaWhatsapp className="w-10 h-10 mb-4 opacity-50" />
              <h3 className="text-xl font-serif font-bold mb-3 relative z-10">
                Recíbelo en tu celular
              </h3>
              <p className="text-sm text-green-50 leading-relaxed mb-6 relative z-10">
