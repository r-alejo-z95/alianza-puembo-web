    ...
    <div className={cn(contentSection, "bg-gray-50/50 pt-12 pb-24 space-y-24")}>
      ...
      <section className="max-w-7xl mx-auto w-full space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            {...fadeIn}
            className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-8 rounded-2xl shadow-md border border-gray-100"
          >
            ...
            >
              ...
              >
                {section.accounts.map((account, aIndex) => (
                  ...
                  >
                    <Card className="border-none shadow-lg bg-white hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden group h-full">
                      <CardHeader className="bg-gray-50/50 p-6 border-b border-gray-100 flex flex-row items-center justify-between space-y-0">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-tighter text-gray-300 group-hover:text-[var(--puembo-green)]/20 transition-colors">
                          Digital
                        </span>
                      </CardHeader>
                      <CardContent className="p-6 space-y-4">
                        ...
                        <div className="space-y-1 bg-gray-50 p-3 rounded-xl flex items-center justify-between">
                          <div className="flex flex-col min-w-0">
                            ...
                            <p className="text-lg font-mono font-bold text-[var(--puembo-green)] tracking-tight">
                              {account.number}
                            </p>
                          </div>
